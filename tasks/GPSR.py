...
class Task():
    ...
    def __init__(self):
        ...
        rospy.set_param('/story/title', 'GPSR')
        ...
        while (True):
            try:
                ...
                if (speech.result == '<robotnames>'):
                    ...
                    # Navegar até ponto de inicio quando a porta abrir
                    # Esperar comando de voz do operador
                    # Entender o comando de voz
                    # Executar o comando
                    # Sair da arena

                    # Provide audio recording and transcript.                    
                    pass
