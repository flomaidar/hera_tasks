...
class Task():
    ...
    def __init__(self):
        ...
        rospy.set_param('/story/title', 'FindMyMates')
        ...
        while (True):
            try:
                ...
                if (speech.result == '<robotnames>'):
                    ...
                    # Procurar pessoas no comodo
                    # Identificar características e local relativo da pessoa
                    # Navegar até o operador
                    # Informar para o operador as caracteristicas e o local relativo de cada convidado
